...
export class FaqComponent implements OnInit {
  ...
  textos : string[] = ['¿Cuánto cuesta jugar a Pokémon UNITE?. Puedes disfrutar de Pokémon UNITE sin coste alguno, pero existen algunos elementos de pago, como las gemas Æos, una de las monedas del juego',
